<template>
  <div class="surface-0 overflow-hidden">
    <movie-details
      :display="showMovieDetails"
      :movie="selectedMovie"
      :toggleDisplay="toggleVisible"
    />
    <div
      class="
        py-4
    ...
    >
      <router-link to="/" class="flex align-items-center">
        <img
          :src="'layout/images/mflix_logo.svg'"
          alt="MongoDB Logo"
          height="25"
          class="mr-0 lg:mr-2"
        />
      ...
      >
        ...
        >
          <li>
            <a
              @click="(e) => this.$router.push('/browse')"
              class="
                flex
                m-0
                md:ml-5
        ...
        <div class="col-12 md:col-2" style="margin-top: -1.5rem">
          <div
            class="
              ...
              md:justify-content-start md:mb-0
              mb-3
            "
          >
            <img
